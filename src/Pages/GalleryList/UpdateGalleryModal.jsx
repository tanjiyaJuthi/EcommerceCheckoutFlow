...
const UpdateGalleryModal = ({setLoader, fetchData, isOpen, setIsOpen, id }) => {
...
//   });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axiosSecure.post(`/api/gallery-update/${id.id}`, formData);
