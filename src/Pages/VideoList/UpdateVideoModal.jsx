...
const UpdateVideoModal = ({ fetchData, isOpen, setIsOpen, id, setLoader }) => {
...
//   });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axiosSecure.post(`/api/video-update/${id.id}`, formData);
