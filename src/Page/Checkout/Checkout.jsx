...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append("course_qty", quantity);
      submitData.append(
          "total_course_fee",
          Number(cart.regular_price) * quantity
      );
      submitData.append(
          "sub_total_course_fee",
          Number(cart.discount_price) * quantity
      );
      
      submitData.append("discount_course_fee", cart.discount_price);
        // console.log(cart);
  ...
  if (!cart) {
    return <h2 className="text-center text-2xl mt-10 font-bold">Cart Empty</h2>;
  }

  const quantity = cart.quantity || 1;

const totalPrice = Number(cart.discount_price) * quantity;
      ...
      >
        ...
        <div className="form-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
            ...
            <div>
              <label className="block font-semibold mb-2">Guardian Phone</label>
                ...
                <table className=" overflow-x-auto  w-full">
                  ...
                  <tbody className="overflow-x-auto ">
                    <tr className="border-b border-gray-300 overflow-x-auto">
                      ...
                      <td>
                        <p className="text-[14.4px] font-bold p-[7px] text-black text-center">
                          Tk {Number(cart.discount_price) * 99999999999999999999999999999999999999999999999999999quantity}
                        </p>
                      </td>
                    </tr>
                  </tbody>
